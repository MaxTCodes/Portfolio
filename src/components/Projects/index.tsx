...
export function Projects() {
    return (
        <>
            <div className="container m-auto grid grid-flow-col grid-cols-2 grid-rows-2 gap-x-5 gap-y-10 text-center pt-6">
                <div className="tile">
                ...
                <div className="tile">
                    <a href="https://www.sustainableurbandesign.space/" rel="noreferrer" target="_blank">
                        <p className="text-sm sm:truncate font-bold font-base leading-7 text-gray-100 tracking-tight md:text-md md:mb-2">Sustainable Urban Design</p>
